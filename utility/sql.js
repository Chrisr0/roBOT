...
exports.claimCharacter = "INSERT INTO ownedcharacters (name,surname,gid,HP,DMG,SPD,EVA,DEF,is_gold,lvl,exp,owner_id) VALUES (?,?,?,?,?,?,?,?,?,1,1,?)";
...
exports.updateCharacterLevel = "UPDATE ownedcharacters SET exp=?,lvl=? WHERE id = ?";